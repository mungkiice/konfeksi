...
<div class="card">
	<div class="card-body">
		...
		<div class="row">
			<a class="btn btn-success ml-3" href="/vendor/produk/create">Tambah Produk</a>
			<div class="col-12">
						...
						<tr>
							...
							<td style="max-width: 80px;">
								<div class="owl-carousel owl-theme full-width">
									...
									<div class="item">
										<img class="img-fluid" src="/storage/{{$image->path}}" style="width: 100%; border-radius: 0; height: auto; margin: 0;">
									</div>
									@endforeach
								</div>
							</td>
							<td>
								<a class="btn btn-warning" href="/vendor/produk/{{$produk->id}}/edit" style="padding: 0.5rem;">Edit</a>
